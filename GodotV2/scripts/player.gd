...
# Player tank - matches Player.java
...
var color: Color = GameData.COLOR_PLAYER1
...
func handle_touch_input() -> void:
	# Touch controls will be handled by the HUD touch buttons
	pass
...
func _draw() -> void:
	...
	var barrel_length = tile_dim * 0.8
