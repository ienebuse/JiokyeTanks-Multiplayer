    ...
    Runnable timerRunnable = new Runnable() {
        ...
        public void run() {
            ...
            if(game6h > 0 && game6h > currentTime) { //6 hours has not elasped
                ...
                life_time = settings.getLong(SettingsManager.LIFE_TIME, 0); // time to next lift when not in 6h mode
                games = settings.getInt(SettingsManager.RETRY_COUNT, CONST.Tank.MAX_GAME_COUNT);
            }
...
//                Log.d("SERVICE","Enemies " + Enemy.lives + " " + Enemy.EnemyCount);
