...
public class MessageRegister {
    ...
    private OnConstructionReceived onConstructionReceived;
    ...
    public void setOnConstructionListener(OnConstructionReceived c) {
        onConstructionReceived = c;
    }
    ...
    public void registerTransactionListener(int purchaseID) {
        transListener.onPurchaseSuccessful(purchaseID);
    }

    public void registerOnConstructionReceived(char[][] stage) {
        onConstructionReceived.onLoadConstructionStage(stage);
    }
}
