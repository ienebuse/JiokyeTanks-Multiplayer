...
//        DEFAULT_SPEED = TankView.tile_dim*1.5f;
        ...
        launched = true;
        this.breakWall = bullet.canBreakWall();
        this.clearBush = false;
    }
    ...
    public void setBreakWall(boolean breakWall) {
    ...
    public void setClearBush(boolean clearBush) {
        this.clearBush = clearBush;
    }
