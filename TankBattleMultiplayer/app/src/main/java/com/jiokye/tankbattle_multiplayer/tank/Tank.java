...
//    static ArrayList<Bullet> activeGameBullets = new ArrayList<>();
...
//        }
    ...
    //todo commented update active game bullets

//    public static void updateActiveGameBullets() {
//        for(int i = 0; i < activeGameBullets.size(); i++) {
//            if(activeGameBullets.get(i).recycle) {
//                activeGameBullets.set(i,null);
//            }
//        }
//
//        while(activeGameBullets.remove(null));
//
//        for(Bullet bullet:activeGameBullets) {
//            bullet.move();
//        }
//    }
