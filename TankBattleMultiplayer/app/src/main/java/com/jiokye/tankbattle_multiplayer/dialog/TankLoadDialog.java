...
public class TankLoadDialog extends Dialog implements View.OnTouchListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dialog_tank_load);
        setCancelable(false);
...
//                    ((TextView) adapterView.getChildAt(c)).setBackground(null);
                    (adapterView.getChildAt(c)).setBackground(ResourcesCompat.getDrawable(TankLoadDialog.this.getContext().getResources(),R.drawable.boarderwhite,null));
                }
//                view.setBackgroundColor(Color.LTGRAY);
                view.setBackground(ResourcesCompat.getDrawable(TankLoadDialog.this.getContext().getResources(),R.drawable.boarder,null));
            }
        });
